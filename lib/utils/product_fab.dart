      ...
      child: Column(
        ...
        children: [
          ...
          Consumer<CategoryProvider>(
            builder: (context, data, child) {
              return DropdownButton(
                ...
                hint: StyleText(text: "Select Category", textColor: Colors.black, textWeight: true,),
                value: selectedValue, 
          ...
          SignButtonStyle(
            text: "Add",
            onTap: () {
              if (fabProductTextController.text.isEmpty ||
                  fabProductDescpController.text.isEmpty ||
                  fabProductPriceController.text.isEmpty ||
                  fabProductQuantityController.text.isEmpty) {
                showDialog(
                  context: context,
                  builder: (context) => AlertDialog(
                    ...
                    content: StyleText(text: "Please fillup required fields", textColor: Colors.black,),
                    actions: [
                      ElevButtonStyle(
                        buttonText: " Okay ",
